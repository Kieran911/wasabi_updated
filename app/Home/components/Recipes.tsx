  ...
  return (
    <>
      <div className="flex flex-col gap-[2rem]">
        ...
        <div
          className={`flex flex-col pt-[6rem] gap-[1rem] px-[8%] md:hidden text-center ${notoSansFont.className}`}
        >
          <h2 className={` font-bold text-3xl capitalize `}>
            {'"'}It{"'"}s Simple: You Bring the Meal, We Bring the Garlic! {'"'}
          </h2>
          <p className={` text-sm`}>
            Made from premium ingredients and packed with real garlic punch, our
            sauce is the easy way to bring bold, unforgettable flavor to any
            dish. Whether you{"’"}re whipping up a quick pasta, dipping fresh
            veggies, or looking for the perfect marinade Just add a spoonful,
            and let garlic take it from there!
          </p>
        </div>
