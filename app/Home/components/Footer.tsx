...
const Footer = () => {
  ...
  return (
    <footer
      className={`flex  bg-[#000000] md:pb-[2rem] md:pt-[4rem]  flex-col  ${forumFont.className}`}
    >
      <div className="w-[150rem] flex flex-col justify-center mx-auto items-center max-w-full">
