...
export const Timeline = () => {
  ...
  return (
    <>
        ...
        <div className="h-[300vh] relative bg-white w-full" ref={targetRef}>
          <div className="sticky top-0 h-screen flex items-center overflow-hidden pb-32">
            ...
            >
              ...
              >
                <span
                  className={`text-[110px] font-extrabold tracking-tight text-black opacity-20 w-full ${forumFont.className}`}
                  style={{
      ...
      {/* Mobile timeline */}
      <div className="flex flex-col gap-15 px-4 py-16 lg:hidden bg-white relative overflow-x-hidden">
        <h2
          className={`text-5xl font-light text-black z-20 text-center ${forumFont.className}`}
        >
          OUR STORY
        </h2>
        {timelineEvents.map((event, idx) => (
          <div key={idx} className="flex flex-col items-center text-center">
            <span
              className={`text-4xl font-bold mb-2 text-black ${forumFont.className}`}
            >
              {event.year}
            </span>
            {event.image && (
            ...
            <h3
              className={`text-lg font-bold uppercase mb-1 text-black ${notoSansFont.className}`}
            >
              {event.title}
            </h3>
            <p
              className={`text-sm text-gray-700 leading-relaxed ${notoSansFont.className}`}
            >
              {event.description}
            </p>
          </div>
