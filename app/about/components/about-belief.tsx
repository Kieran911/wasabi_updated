...
export const AboutAndBelief = ({ setCanShow }: any) => {
  ...
  return (
    <div ref={beliefRef} className="h-[350vh] w-full relative overflow-x-hidden">
      ...
      <div
        ref={beliefRef}
        className=" w-full absolute left-0 bottom-0  pt-[7rem] z-20 flex items-center justify-center bg-black overflow-hidden"
      >
        <motion.div
          className="w-full max-w-[1200px] relative   mx-auto flex flex-col items-center text-center px-4"
          layout
