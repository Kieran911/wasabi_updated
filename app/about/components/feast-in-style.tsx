...
export const FeastInStyle = () => {
  return (
    <div className=" h-[110vh] relative  w-full overflow-hidden">
      <Image
        src={bgImage}
        alt="Feast table"
      ...
      <div className="absolute inset-0 z-20 bg-transparent h-full w-full flex items-center justify-center">
        <div className="w-full max-w-[500px] md:w-[35%] min-w-0 aspect-square m-auto flex flex-col items-center justify-center gap-5 px-4">
          <h3
            className={`text-[#FEFAF4] text-3xl md:text-7xl text-center tracking-wider ${forumFont.className}`}
          >
            FEAST IN <br />
            STYLE
          </h3>
          <p
            className={`text-[#FEFAF4] tracking-widest font-light text-lg ${notoSansFont.className}`}
          >
